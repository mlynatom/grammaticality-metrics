...
if [ ! -d "$homedir/gug-data" ]; then
    ...
    git clone https://github.com/EducationalTestingService/gug-data.git $homedir/gug-data
    echo "Done"
fi
...
echo $test_opt
python3 $homedir/grammatical_model.py -f $wkdir/features/gug_sentences.txt.json \
